...
export const routes: Routes = [
{
    ...
    [
        ...
        },
        {
            path:'config',
            title:'Configuración',
            loadComponent: () => import('./main/pages/Configuracion/Configuracion.component')
        },
        {
            path:'ayc-data',
            title:'AYC',
        ...
        },
        {
            ...
            loadComponent: () => import('./main/pages/VentasBebidas/VentasBebidas.component')
        },
        {
            path:'mix-ventas',
            title:'Mix de ventas',
            loadComponent: () => import('./main/pages/MixDeVenta/MixDeVenta.component')
        },
        {
            path:'diferencias',
            title:'Diferencias',
